...
# Issues
This repo is a as brain-dead as I could make it and is loosely based off of the go tool script from [catthehacker](https://github.com/catthehacker/docker_images/blob/master/linux/ubuntu/scripts/go.sh). I am not very experienced with bash so if you have any improvements, recommendations, or bug fixes please open an issue or a PR.
