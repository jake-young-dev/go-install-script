# go-install-script
A simple, hacky script to install a single Golang version on git action runner workflows for faster pipelines. When using [actions/setup-go](https://github.com/actions/setup-go) my testing pipelines averaged 8-10 minutes, however, with this script they are down to ~20s.
